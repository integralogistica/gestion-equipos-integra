...
from .views import (
    ...
    EquipoHistorialMovimientoView, ReporteIncidenteViewSet,
    clearance_info
)
...
urlpatterns = [
    ...
    path('equipos/historial/', EquipoHistorialMovimientoView.as_view(), name='historial-equipo-movimiento-list'),
