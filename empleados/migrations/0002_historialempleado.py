    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empleado_str', models.CharField(blank=True, max_length=200, null=True, verbose_name='Empleado (texto)')),
                ...
                ('empleado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='historial_cambios', to='empleados.empleado')),
